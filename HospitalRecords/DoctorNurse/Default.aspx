<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HospitalRecords.DoctorNurse.Default" %>
        ...
        <div>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				<ul class="navbar-nav ml-auto">
					<li class="navbar-item"><label id="displayName2" class="lead" runat="server"></label></li>
				</ul>
			</div>
			</nav>
...
<asp:GridView ID="DoctorNurseGridview" runat="server" AutoGenerateColumns="False" DataSourceID="AnnouncmentSource" class="table table-striped">
			<Columns>
